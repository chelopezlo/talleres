...
<head>
    ...
    <title>Esencia 2016 | P&aacute;gina de resitro</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Esencia 2016 </b> <br />Gesti&oacute;n de asistencia</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('rut') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="rut" value="{{ old('rut') }}" placeholder="RUT">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
        ...
        <a href="{{ url('/login') }}" class="text-center">Ya estoy inscrito/a</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
